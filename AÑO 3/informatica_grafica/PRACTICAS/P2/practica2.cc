...
void mostrarInstruccionesEjecucion(){
	...
	cout << "Opciones: " << endl;
	cout << "./practica2" << endl;
	cout << "./practica2 -c [ruta_fichero_ply]" << endl;
	cout << "./practica2 -r [ruta_perfil_ply_revolucion] -n [numero_segmentos] -e [eje_revolucion]" << endl;
	cout << "./practica2 -b [ruta_perfil_ply_barrido] -n [número_segmentos] -l [longitud_barrido]" << endl;
...
int main(int argc, char **argv) {
	...
	if(argc == 2 && (argv[1] == std::string("-h") || argv[1] == std::string("--help")))
		...
		glutCreateWindow("Practica 2: Juan Carlos Ruiz Garcia");
