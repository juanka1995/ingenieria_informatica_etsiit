...
private:
	...
	// Luces
	Luz luzDireccional, luzPosicional;
	bool iluminacionActiva;
	bool suavizadoActivo;

	// Textura
	GLuint textura_id;
	int orientacionTextura;
...
public:
	...
	void activarDesactivarIluminacion();

	// Activar/desactivar suavizado
	void activarDesactivarSuavizado();
