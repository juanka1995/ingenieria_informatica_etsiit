...
Ojo::Ojo(){
    ...
    esclera.calcularNormalesCaras();
    esclera.calcularNormalesVertices();

    pupila.calcularNormalesCaras();
    pupila.calcularNormalesVertices();
}
...
void Ojo::dibujarSinSuavizado(){
    // Esclera
    glPushMatrix();
        esclera.modifyActualColor(Color(0.90,0.90,0.90)); // Color blanco ojo
        glScalef(0.5,0.5,0.5);
        esclera.dibujarSinSuavizado();
    glPopMatrix();
    // Pupila
    glPushMatrix();
        pupila.modifyActualColor(Color(0.0,0.0,0.0)); // Color negro pupila
        glTranslatef(0.0,0.0,0.2);
        glScalef(0.15,0.15,0.15);
        pupila.dibujarSinSuavizado();
    glPopMatrix();
}

void Ojo::dibujarConSuavizado(){
    // Esclera
    glPushMatrix();
        esclera.modifyActualColor(Color(0.90,0.90,0.90)); // Color blanco ojo
        glScalef(0.5,0.5,0.5);
        esclera.dibujarConSuavizado();
    glPopMatrix();
    // Pupila
    glPushMatrix();
        pupila.modifyActualColor(Color(0.0,0.0,0.0)); // Color negro pupila
