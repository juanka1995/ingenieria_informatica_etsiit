...
Brazo::Brazo(){
    ...
    antebrazo_mano.calcularNormalesCaras();
    antebrazo_mano.calcularNormalesVertices();

    codo.calcularNormalesCaras();
    codo.calcularNormalesVertices();
    
    hombro.calcularNormalesCaras();
    hombro.calcularNormalesVertices();
}
...
void Brazo::dibujarSinSuavizado(){
    // Brazo completo
    glPushMatrix();
    glScalef(5,5,5);
        glRotatef(grHombro,1.0,0.0,0.0);
        ...
        glPushMatrix();
            ...
            glPushMatrix();
                ...
                glPushMatrix();
                    ...
                    glRotatef(180.0,1.0,0.0,0.0);
                    glScalef(0.6,0.8,0.6);
                    antebrazo_mano.dibujarSinSuavizado();
                glPopMatrix();
                // Codo
                glPushMatrix();
                    codo.modifyActualColor(Color(1.0,0.80,0.0)); // Color amarillo piel
                    glScalef(0.26,0.26,0.26);
                    codo.dibujarSinSuavizado();
                glPopMatrix();
            glPopMatrix();
        glPopMatrix();
    glPopMatrix();
...
void Brazo::dibujarConSuavizado(){
    // Brazo completo
    glPushMatrix();
    glScalef(5,5,5);
        glRotatef(grHombro,1.0,0.0,0.0);
        ...
        glPushMatrix();
            ...
            glPushMatrix();
                ...
                glPushMatrix();
                    ...
                    glRotatef(180.0,1.0,0.0,0.0);
                    glScalef(0.6,0.8,0.6);
                    antebrazo_mano.dibujarConSuavizado();
                glPopMatrix();
                // Codo
                glPushMatrix();
                    codo.modifyActualColor(Color(1.0,0.80,0.0)); // Color amarillo piel
                    glScalef(0.26,0.26,0.26);
                    codo.dibujarConSuavizado();
                glPopMatrix();
            glPopMatrix();
        glPopMatrix();
    glPopMatrix();
