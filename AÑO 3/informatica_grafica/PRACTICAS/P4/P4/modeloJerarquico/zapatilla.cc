...
Zapatilla::Zapatilla(){
    ...
    base_zapatilla.calcularNormalesCaras();
    base_zapatilla.calcularNormalesVertices();

    empeine.calcularNormalesCaras();
    empeine.calcularNormalesVertices();
}
...
void Zapatilla::dibujarSinSuavizado(){
    // Base del zapato
    glPushMatrix();
        base_zapatilla.modifyActualColor(Color(0.85,0.85,0.85)); // Color gris calcetines y base zapato
        glScalef(0.9,1,1.5);
        base_zapatilla.dibujarSinSuavizado();
    glPopMatrix();
    ...
    glPushMatrix();
        ...
        glTranslatef(0.0,0.2,0.0);
        glScalef(0.9,0.6,1.4);
        empeine.dibujarSinSuavizado();
    glPopMatrix();
}

void Zapatilla::dibujarConSuavizado(){
    // Base del zapato
    glPushMatrix();
        base_zapatilla.modifyActualColor(Color(0.85,0.85,0.85)); // Color gris calcetines y base zapato
        glScalef(0.9,1,1.5);
        base_zapatilla.dibujarConSuavizado();
    glPopMatrix();
