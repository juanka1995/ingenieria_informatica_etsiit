...
Cabeza::Cabeza(){
    ...
    nariz.calcularNormalesCaras();
    nariz.calcularNormalesVertices();

    oreja.calcularNormalesCaras();
    oreja.calcularNormalesVertices();

    pelo.calcularNormalesCaras();
    pelo.calcularNormalesVertices();

    cara.calcularNormalesCaras();
    cara.calcularNormalesVertices();

    boca.calcularNormalesCaras();
    boca.calcularNormalesVertices();

    cuello.calcularNormalesCaras();
    cuello.calcularNormalesVertices();
}
...
void Cabeza::dibujarSinSuavizado(){
    glScalef(5.0,5.0,5.0); // Borrar
    ...
    glPushMatrix();
        ...
        glPushMatrix();
            ...
            glPushMatrix();
                cara.modifyActualColor(Color(1.0,0.80,0.0)); // Color amarillo piel
                cara.dibujarSinSuavizado();
            glPopMatrix();
            // Ojo Derecho
            glPushMatrix();
                glTranslatef(-0.2,0.1,0.4);
                glScalef(0.8,0.8,0.8);
                ojo.dibujarSinSuavizado();
            glPopMatrix();
            // Ojo Izquierdo
            glPushMatrix();
                glTranslatef(0.2,0.1,0.4);
            ...
            glPushMatrix();
                ...
                glRotatef(14.0,1.0,0.0,0.0);
                glScalef(0.75,0.52,0.75);
                boca.dibujarSinSuavizado();
            glPopMatrix();
        glPopMatrix();
    glPopMatrix();
}

void Cabeza::dibujarConSuavizado(){
    glScalef(5.0,5.0,5.0); // Borrar
    ...
    glPushMatrix();
        ...
        glPushMatrix();
            ...
            glPushMatrix();
                cara.modifyActualColor(Color(1.0,0.80,0.0)); // Color amarillo piel
                cara.dibujarConSuavizado();
            glPopMatrix();
            // Ojo Derecho
            glPushMatrix();
                glTranslatef(-0.2,0.1,0.4);
                glScalef(0.8,0.8,0.8);
                ojo.dibujarConSuavizado();
            glPopMatrix();
            // Ojo Izquierdo
            glPushMatrix();
                glTranslatef(0.2,0.1,0.4);
