...
private:
   Celda * cabecera;
	 ...
	 */
		...
		/*
			Se encarga de copiar una instancia de la clase copia en otra
		*/
...
/*
	Constructor copia de la clase lista
*/
	 Lista(const Lista &l);
...
/*
	Sobrecargamos el operador de asignacion
*/
Lista& operator=(const Lista &l);

/*
	Sobrecargamos el operador de '+' para poder realicar operaciones
	de concatenacion de listas
*/
Lista operator+(const string &dato)const;
