...
int main(){
  ...
  plano.destruir(); //Es necesario llamar al metodo destruir ya que existe
                    //un fallo en el codigo y la segunda vez que se llama
                    //a origen.plano, datos se pone a cero y como se pone a
                    //cero no se llama a destruir por lo que dejaria memoria
                    //sin liberar.
