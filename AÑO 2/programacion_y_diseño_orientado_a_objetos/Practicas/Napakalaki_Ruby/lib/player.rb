...
class Player
  attr_accessor :enemy
  attr_reader :name, :hiddenTreasures, :visibleTreasures, :level, :canISteal, :dead, :pendingBadConsequence
  ...
  protected :oponentLevel, :shouldConvert, :combatLevel
