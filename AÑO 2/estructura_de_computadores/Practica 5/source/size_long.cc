...
const unsigned long long MAXSIZE = 1ull << 33; // maximun line size to test: 32MB
const unsigned GAP = 12;          // gap for cout columns
const unsigned REP = 1;         // number of repetitions of every test
const unsigned long long STEPS = 1e6;       // steps
