...
create table faltas(
  codJ constraint codJ_no_nulo_faltas not null,
  ELocal constraint eq1_no_nulo_faltas not null,
  EVisitante constraint eq2_no_nulo_faltas not null,
  num number(1) default 0 constraint valor_entre_0_5 check (num>=0 and num<=5),
