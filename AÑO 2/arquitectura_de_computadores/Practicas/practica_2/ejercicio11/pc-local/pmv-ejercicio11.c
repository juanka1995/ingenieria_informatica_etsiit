...
gcc -O2 pmv-ejercicio11.c -o pmv-ejercicio11 -lrt -fopenmp
gcc -O2 -S pmv-ejercicio11.c -lrt -fopenmp //para generar el código ensamblador
Para ejecutar use: pmv-ejercicio11.c n_filas n_columnas
*/
